...
include_once 'common.php';
   ...
   $result_set4=mysql_query("select * from music  where id ='".$id_item."' ");
 $row4=mysql_fetch_row($result_set4) ;
 $item_name=$row4['1']  ;
	$item_rating=$row4['5'];
	$id_work =$row4[9];  
	$ext=$row4[7]; 
     $select_rating = mysql_query ("select * from opinion where   id_item=".$id_item." AND id_user=".$id_user." AND type='music' " ) ;
...
<title><?php echo $lang['MUSIC']; ?></title>
 ...
 <script>var _gaq=[['_setAccount','UA-20257902-1'],['_trackPageview']];(function(d,t){ var g=d.createElement(t),s=d.getElementsByTagName(t)[0]; g.async=1;g.src='//www.google-analytics.com/ga.js';s.parentNode.insertBefore(g,s)}(document,'script'))</script>
    <script src="js/audio_js/audio.min.js"></script>
<!--aaa-->		
...
<body>
 ...
 <?php 
  ...
  $result_set11= mysql_query ("Select * from music where work=".$id_work."");
   ...
   {  echo "<ul id=\"one_related_item\">  " ; 
      echo "<li  > " ; 
	   ...
	   echo "<a href=\"music_affich.php?id_item=".$id_rel."\" TITLE=\"".$changes_version_related."\"> ".$name_rel." </a>" ; 
...
<div id="container">
  ...
  <?php include('header_nav_co.php'); ?>
	 ...
	 <div id="AUDIO_header" style="padding:40px; " >
  ...
  <input type="hidden" name="id_item" value="<?php   echo $id_item ;   ?>"> 
   <input type="hidden" name="id_user" value="<?php   echo $id_user ;   ?>"> 
      ...
      <input type="hidden" name="type" value='m' > 
       ...
       <div id="audio_player_zone"  >
    
      <h1 class="song_Name">audio </h1>
    
     
    
   <div id="player">
       <audio  src="<?php echo "upload/music/$id_work/$id_item.$ext" ;?>"preload="auto"   />
  </div>
    ...
    <li id="download"> 
 	...
 	<a href="<?php echo "upload/music/$id_work/$id_item.$ext" ;?>" download ><img src="images/download_item.png" width="40px" height="60px"></a>
 	 </li>
 
	<li d="repport">
  
  	<a href="aymen/report_item.php?id_item=<?php echo $_GET['id_item']?>&type=m"> <img src="images/report.png" width="40px" height="60px"> </a>
  	   </li>
    ...
    <a href="#"id="show_comment_zone" ><img src="images/comment_zone(s&h).png"> </a> 
       ...
       <a href="#"id="hide_related_item" hidden="able"><img src="images/fleche.png"> </a> 
             ...
             <div id="comment_zone"   >
   <?php 
   $comment= mysql_query("select * from commentaires_music  where id_article =".$id_item."   ");
      ...
      <li>
       ...
       echo "<ul>";
          ...
          <div id="button_comment"  >
           <form id="update_comment" method="POST" action="aymen/update_comment_item.php">
        ...
        <input type="hidden" name="type_article" value="music">
  ...
  <p>Do  you like it ? You want to make it better : so what you're waiting upload your version :D </p> <a href="aymen/upload_item_audio.php?id_item=<?php echo $id_item ;?>" >  UPLOAD  </a>
