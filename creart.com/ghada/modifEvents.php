...
$modif=mysql_query("SELECT * FROM events where (id='$login') ");

$res=mysql_fetch_array($modif);
...
<br><br>
 <div id="content">
     <h2><?php echo $lang['HMODIF']; ?></h2>
	 <br/>
	
	 
        <div  class="form">
    		
               <form id="contactform" name="addevent_form" method="post" action="req_modifevent.php?id=<?php echo $res['id'] ?>"> 
 <p class="contact"><label for="name"><?php echo $lang['NAMEEVENT']; ?></label></p> 
<input id="name" name="eventname" placeholder="Title Of The Event" required="" tabindex="1" type="text" value="<?php echo $res['eventname'] ?>">
...
<input id="pac-input" name="adresse" class="controls" type="text"
        placeholder="Enter a location" value="<?php echo $res['adresse'] ?>">
...
<p><input id="datepicker" name="date" type="date" size="28" required="required" value="<?php echo $res['date'] ?>"  /></p>
 


<p class="contact"><label for="name"><?php echo $lang['DURATION']; ?></label></p>
<input class="birthday" maxlength="2" name="duration"  placeholder="Day" min="1" max="31"  type="number" required="" value="<?php echo $res['duration'] ?>"><label> <?php echo $lang['DAY']; ?>(s)</label>

<p class="contact"><label for="name"><?php echo $lang['STARTTIME']; ?></label></p>
<input type="time" name="starttime" value="<?php echo $res['starttime'] ?>"> 

<p class="contact"><label for="name"><?php echo $lang['ENDTIME']; ?></label></p>
 <input type="time" name="endtime" value="<?php echo $res['endtime'] ?>"> 
<div class="mbl">
...
<input id="name" name="ticketprice" placeholder="ex : 002.50DT" required="" tabindex="1" type="text" pattern="[0-9]{3}[.][0-9]{2}[A-Z]{2}" value="<?php echo $res['ticketprice'] ?>">
 <p class="contact"><label for="name"><?php echo $lang['TICKETLINK']; ?></label></p> 
<input id="name" name="ticketlink" placeholder="<?php echo $lang['TICKETTEXT']; ?>." required="" tabindex="1" type="text" value="<?php echo $res['ticketlink'] ?>">
 </br>
  <p class="contact"><label for="name"><?php echo $lang['DESCRIPTION']; ?></label></p> 
<textarea id="notes" placeholder="<?php echo $lang['DESCTEXT']; ?>" rows="3" name="description" cols="50" type="text" value="<?php echo $lang['DESCTEXT']; ?>"></textarea>
 </br> </br>
 
 

       
<input class="buttom" name="submit" id="submit" tabindex="5" value="<?php echo $lang['SAVE']; ?>" type="submit">
</form> 
</div>
