...
mysql_query("INSERT INTO events (eventname,category,adresse,date,duration,starttime,endtime,timezone,ticketprice,ticketlink,description,username) VALUES ('$eventname','$category','$adresse','$date','$duration','$starttime','$endtime','$timezone','$ticketprice','$ticketlink','$description','$user_check')");
...
<body>
<script>  	swal("<?php echo $lang['GOODJOB']; ?>", "<?php echo $lang['ADDED']; ?>", "success");
 </script>
