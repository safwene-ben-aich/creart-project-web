...
function delete_id(id)
{
	if(confirm('Sure to delete ?'))
	{
		...
		'adminMusic.php?delete_id='+id;
	<?php
if (isset($_GET['delete_id']) ) 
{
	$id=$_GET['delete_id'];
	$sql_query="delete from music where id_music='$id'";
...
{
$id=$row[0];
$signal =mysql_result (mysql_query("SELECT COUNT(report)  FROM opinion where id_item='$id'&&report=1&&type='music'"),0);
