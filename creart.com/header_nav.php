     <div id="header">
          ...
          <ul id="nav1">
     <li><a href="/creart.com/connect.php"><?php echo $lang['CONNECT']; ?></a></li>
     <li><a href="/creart.com/subscribe.php"><?php echo $lang['SUBSCRIBE']; ?></a></li> 
     <li><a href="/creart.com/Help.html"><?php echo $lang['HELP']; ?></a></li>
     </ul>
...
<div id='search-box'>
  <form action='/search' id='search-form' method='get' target='_top'>
    ...
    <button id='search-button' type='submit'><span><?php echo $lang['SEARCH']; ?></span></button>
     ...
     <li><a href="https://twitter.com/CreartWebsite"><img src="images/Twitter.png" width="33" height="38"/></a></li>
     <li><a href="https://www.facebook.com/pages/Creart/471236503051389?__mref=message_bubble"><img src="images/Facebook.png" width="33" height="38"/></a></li>
     <li><a href="https://plus.google.com/u/0/117614243785122905117/about"><img src="images/g+.png" width="33" height="38"/></a></li>

     </ul>
     
          <logo><a href="/creart.com/home.php"><img src="images/LogoSite.png" alt="logo" width="215" height="148" /></a></logo>
 ...
 <li class="aqua"><a href="/creart.com/cinema/cinema.php?sort=nb_view"><?php echo $lang['MOST_VIEWED']; ?></a></li>
  ...
  ?></a></li>
    ...
    <li><a href="/creart.com/music/music.php?sort=taux_rating" ><?php echo $lang['MUSIC']; ?></a>
           <ul>
 ...
 <li class="aqua"><a href="/creart.com/music/music.php?sort=nb_view"><?php echo $lang['MOST_VIEWED']; ?></a></li>
  <li class="red"><a href="/creart.com/music/music.php?sort=date_pub"><?php echo $lang['LATEST']; ?></a></li>
     ...
     </li> <li><a href="/creart.com/photography/photography.php?sort=kind" ><?php echo $lang['PHOTOGRAPHY']; ?></a>
           <ul>
 ...
 <li class="aqua"><a href="/creart.com/photography/photography.php?sort=nb_view"><?php echo $lang['MOST_VIEWED']; ?></a></li>
  <li class="red"><a href="/creart.com/photography/photography.php?sort=date_pub"><?php echo $lang['LATEST']; ?></a></li>
     ...
     </li><li><a href="/creart.com/literature/literature.php?sort=kind" ><?php echo $lang['LITERATURE']; ?></a>
           <ul>
