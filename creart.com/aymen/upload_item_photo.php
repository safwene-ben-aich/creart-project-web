...
<title>Upload new Photo version</title>
...
<form id="addPhoto" enctype="multipart/form-data" method="post" action="uploading_photo.php" >
	<ul id="ul_addPhoto">
        <li id="li_addPhoto">
        	<label id="label_addPhoto" for="name">Your Masterpiece's Name :</label>
            <input id="input_addPhoto" placeholder=" Insert the title of your version .. " type="text" required maxlength="40" size="50" name="Photo_name" />
        </li>
        ...
        <li id="li_addPhoto"> 
          ...
          <li id="li_addVideo"> 
            ...
            <textarea id="textarea_addPhoto" placeholder="Describe your masterpiece..." required cols="50" rows="5" name="description"></textarea>
		</li>
