...
<title>Upload new Video version</title>
...
<form id="addPhoto" enctype="multipart/form-data" method="post"  action ="uploading_video.php">
	<ul id="ul_addPhoto">
        <li id="li_addPhoto">
    ...
    <p>
      <input type="hidden"    name ="id_user" value="<?php echo $id_user; ?> "  >
        ...
        <button  id="upload_button" type="submit"  >Add Masterpiece</button>
