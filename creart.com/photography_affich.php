<?php 
  ...
  $name_user=$row['name'];
	 ...
	 $result_set4=mysql_query("select * from photography  where id ='".$id_item."' ");
	...
	$id_work =$row4[9];  
	$ext=$row4[7];  
	 $select_rating = mysql_query ("select * from opinion where   id_item=".$id_item." AND id_user=".$id_user." AND type='photography' " ) ;
...
<title><?php echo $lang['PHOTOGRAPHY']; ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="js/jQuery-slideshow-plugin/plugin.css">
...
<body>
  ...
  $result_set11= mysql_query ("Select * from photography where work=".$id_work."");
   ...
   {  echo "<ul  id=\"one_related_item\">  " ; 
      echo "<li> " ; 
	   ...
	   echo "<a href=\"photography_affich.php?id_item=".$id_rel."\" TITLE=\"".$changes_version_related."\" > ".$name_rel." </a>" ; 
...
<div id="container">
	 ...
	 <div id="Photography_header" style="padding:40px; " >
  ...
  <input type="hidden" name="id_item" value="<?php   echo $id_item ;   ?>"> 
   <input type="hidden" name="id_user" value="<?php   echo $id_user ;   ?>"> 
      ...
      <input type="hidden" name="type" value='p' > 
       ...
       <div id="Photography_player" name ="player">
     ...
     <div id="photo_shower" >
        <img id="photo_show"src="<?php echo "/creart.com/upload/photography/$id_work/$id_item.$ext" ;?>"    >
   	...
   	<ul> 
    <li id="download"> 
 <a href="<?php echo "upload/photography/$id_work/$id_item.$ext" ;?>" download > <img src="images/download_item.png" width="40px" height="60px"> </a>
 </li>
  <li id="repport" > 
  <a href="aymen/report_item.php?id_item=<?php echo $_GET['id_item']?>&amp;type=p"> <img src="images/report.png" width="40px" height="60px"> </a>
  </li>
     <li>
    ...
    <a href="#"id="show_comment_zone" ><img src="images/comment_zone(s&amp;h).png"> </a> 
       ...
       <a href="#"id="hide_related_item" hidden="able"><img src="images/fleche.png"> </a> 
             ...
             <div id="comment_zone"  >
     <?php 
   $comment= mysql_query("select * from commentaires_photography  where id_article =".$id_item." ");
	...
	?>
      ...
      <li>
       ...
       echo "<ul>";
        ...
        <input type="hidden" name="type_article" value="photography">
  ...
  <p>Do you like it ? You want to make it better : so what you're waiting upload your version :D </p> <a href="aymen/upload_item_photo.php?id_item=<?php echo $id_item ;?>">  UPLOAD  </a>
