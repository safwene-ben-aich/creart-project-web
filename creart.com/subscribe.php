     ...
     <div id="featured">
      ...
      <div  class="form">
    		<form id="contactform" name="subscribe_form" method="post" action="addsubscriber.php" enctype="multipart/form-data"  > 
    			...
    			<p class="contact"><label for="email">Email</label> <label for="email" id="error_subscribe"><?php if(!empty($erreur_mail)) { ?> <?php echo $erreur_mail ; ?> <?php } ?></label></p> 
...
<div>
           ...
           <p class="contact"><label> <?php echo $lang['I_ACCEPT_THE']; ?> <a id="cond-about" href="aboutus.php" target="_blank"><?php echo $lang['TERMS_AND_CONDITIONS']; ?></a></label></p>
